...
def compute_fscore(nominal_test, anomaly_test, encoder, decoder, tshd):
    tp = []
    fp = []
    tn = []
    fn = []

    for batch in nominal_test:
...
def main():
    ...
    vae_threshold = 551.871557103979
    VAE = "mnist_vae_dola_all_classes"
