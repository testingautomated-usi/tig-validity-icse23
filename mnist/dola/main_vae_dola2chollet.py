...
pos_mean = layers.Dense(original_dim, name='pos_mean')(x)
pos_log_var = layers.Dense(original_dim, name='pos_log_var')(x)
...
class VAE(tf.keras.Model):
    ...
    def train_step(self, data):
        with tf.GradientTape() as tape:
            ...
            loss_m = K.square(outputs[0] - data) / K.exp(outputs[1])
...
vae_name = "trained/mnist_vae_dola"
