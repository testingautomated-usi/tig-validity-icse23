...
rec_loss_summary = np.load('losses/stocco_rec_losses_SVHN_all_classes.npy')
calc_and_store_thresholds(rec_loss_summary, "losses/selforacle_thresholds_SVHN_all_classes")
