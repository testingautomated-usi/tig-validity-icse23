...
# multiclass
#vae_threshold = 5281.31494140625
# f1: 0.972227905193511

# 5vs4
# tshd: 1950.474853515625
# f1: 0.6553134935188448
...
nominal = np.load('losses/dola_rec_losses_IMAGENET_all_classes.npy')
anomalies = np.load('losses/dola_rec_losses_CELEBA_all_classes.npy')
